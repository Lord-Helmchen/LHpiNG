...
namespace LHpiNG.db.Migrations
{
    ...
    [Migration("20190214192241_addCollNrToProducts")]
    partial class addCollNrToProducts
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LHpiNG.Cardmarket.PriceGuide", b =>
                {
                    ...
                    b.HasIndex("PreviousPriceGuideUid")
                        .IsUnique()
                        .HasFilter("[PreviousPriceGuideUid] IS NOT NULL");
            ...
            modelBuilder.Entity("LHpiNG.Cardmarket.PriceGuide", b =>
                {
                    b.HasOne("LHpiNG.Cardmarket.PriceGuide", "PreviousPriceGuide")
                        .WithOne()
                        .HasForeignKey("LHpiNG.Cardmarket.PriceGuide", "PreviousPriceGuideUid");
